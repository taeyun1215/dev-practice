...
public class SortPerformanceTest {
    ...
    public void testReadPerformanceBasic() {
        ...
        System.out.println("Auto Select Time: " + stopWatch.getTotalTimeSeconds() + " seconds");
    ...
    public void testReadPerformanceUUID() {
        ...
        System.out.println("UUID Select Time: " + stopWatch.getTotalTimeSeconds() + " seconds");
        System.out.println(stopWatch.prettyPrint());
    }
    ...
    public void testReadPerformanceULID() {
        ...
        System.out.println("ULID Select Time: " + stopWatch.getTotalTimeSeconds() + " seconds");
        System.out.println(stopWatch.prettyPrint());
    }
}
